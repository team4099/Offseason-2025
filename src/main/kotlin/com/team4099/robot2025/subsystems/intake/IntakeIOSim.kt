...
object IntakeIOSim : IntakeIO {
    ...
    private val armPIDController =
        ProfiledPIDController(
            ...
            TrapezoidProfile.Constraints(IntakeConstants.SIM_VELOCITY, IntakeConstants.SIM_ACCELERATION)
        )
    ...
    override fun setRollerVoltage(voltage: ElectricalPotential) {
        val clampedVoltage =
            clamp(
                voltage, -IntakeConstants.Rollers.VOLTAGE_COMPENSATION, IntakeConstants.Rollers.VOLTAGE_COMPENSATION
            )
