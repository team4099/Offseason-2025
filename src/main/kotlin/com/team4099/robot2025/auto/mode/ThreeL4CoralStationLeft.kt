...
class ThreeL4CoralStationLeft(
  ...
  companion object {
    private val trajectory1 =
      Choreo.loadTrajectory<SwerveSample>("ThreeL4CoralStationLeft/1CenterToL4.traj").get()
    private val trajectory2 =
      Choreo.loadTrajectory<SwerveSample>("ThreeL4CoralStationLeft/2L4ToCoralStation.traj").get()
    private val trajectory3 =
      Choreo.loadTrajectory<SwerveSample>("ThreeL4CoralStationLeft/3CoralStationToL4.traj").get()
    private val trajectory4 =
      Choreo.loadTrajectory<SwerveSample>("ThreeL4CoralStationLeft/4L4ToCoralStation.traj").get()
    private val trajectory5 =
      Choreo.loadTrajectory<SwerveSample>("ThreeL4CoralStationLeft/5CoralStationToL4.traj").get()
