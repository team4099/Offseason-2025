...
object TunerConstants {
    ...
    private const val kDriveGearRatio = 1.0 / DrivetrainConstants.MK4_DRIVE_SENSOR_GEAR_RATIO // 5.902777777777778
    private const val kSteerGearRatio = 1.0 / DrivetrainConstants.MK4N_STEERING_SENSOR_GEAR_RATIO // 18.75
    ...
    val CTREDrivetrainConstants: SwerveDrivetrainConstants? = SwerveDrivetrainConstants()
    ...
    val FrontLeft: SwerveModuleConstants<TalonFXConfiguration?, TalonFXConfiguration?, CANcoderConfiguration?>? =
        ConstantCreator.createModuleConstants(
            kFrontLeftSteerMotorId, kFrontLeftDriveMotorId, kFrontLeftEncoderId, kFrontLeftEncoderOffset.inRotations,
            kFrontLeftXPos.inInches, kFrontLeftYPos.inInches, kInvertLeftSide, kFrontLeftSteerMotorInverted, kFrontLeftEncoderInverted
        )
    ...
    val BackLeft: SwerveModuleConstants<TalonFXConfiguration?, TalonFXConfiguration?, CANcoderConfiguration?>? =
        ConstantCreator.createModuleConstants(
            kBackLeftSteerMotorId, kBackLeftDriveMotorId, kBackLeftEncoderId, kBackLeftEncoderOffset.inRotations,
            kBackLeftXPos.inInches, kBackLeftYPos.inInches, kInvertLeftSide, kBackLeftSteerMotorInverted, kBackLeftEncoderInverted
        )
    val BackRight: SwerveModuleConstants<TalonFXConfiguration?, TalonFXConfiguration?, CANcoderConfiguration?>? =
        ConstantCreator.createModuleConstants(
            kBackRightSteerMotorId, kBackRightDriveMotorId, kBackRightEncoderId, kBackRightEncoderOffset.inRadians,
            kBackRightXPos.inInches, kBackRightYPos.inInches, kInvertRightSide, kBackRightSteerMotorInverted, kBackRightEncoderInverted
        )
    ...
    fun createDrivetrain(): CommandSwerveDrivetrain {
        return CommandSwerveDrivetrain(
            CTREDrivetrainConstants!!, FrontLeft, FrontRight, BackLeft, BackRight
        )
    }
