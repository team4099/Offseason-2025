  ...
  override fun periodic() {
    ...
    when (currentState) {
      ...
      IntakeState.TARGETING_POSITION -> {
        ...
        if (inputs.pivotPosition <= IntakeConstants.ANGLES.NOT_CLIPPING_ELEVATOR_THRESHOLD && rollerVoltageTarget != IntakeConstants.Rollers.IDLE_VOLTAGE) io.setRollerVoltage(rollerVoltageTarget)
        nextState = fromRequestToState(currentRequest)
      }
    }
