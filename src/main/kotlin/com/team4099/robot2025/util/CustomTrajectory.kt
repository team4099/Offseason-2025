...
@Deprecated(
  message = "Class written for thrifty drive, needs to be rewritten for TunerSwerveDrivetrain"
)
class CustomTrajectory(
  ...
  //        val desiredRotation =
  // trajectoryGenerator.holonomicRotationSequence.sample(time.inSeconds)
  //        val poseReference =
