...
@Deprecated(
  message = "Command written for thrifty drive, needs to be rewritten for TunerSwerveDrivetrain"
)
...
//        nextDriveState.vxMetersPerSecond.meters.perSecond to
...
//    )
//
//    CustomLogger.recordDebugOutput("Pathfollow/isAtReference",
